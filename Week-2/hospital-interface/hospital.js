...
let doctorKai = new Employee ('Dr.Kaioo', 'Doctor', 'kaioo', 'kaioo123');
let adminKai = new Employee ('Admin', 'Admin', 'admin', 'admin123');
let identity = [];
let patientArr = [];
let employeeArr = [];
let stage = 0;

rl.setPrompt(`===================================================\nWelcome to ${hospital.name} Hospital\nJl.Sumpah Gua Keren 45, Jakarta Tenggara, 77777\n===================================================\nPlease enter your username:\n`);
rl.prompt();

rl.on('line', (answer) => {
  if (answer === 'kaioo' || answer === 'admin') {
    identity.push(answer);
  }
  if (identity[0] === 'kaioo' || identity[0] === 'admin') {
    if (stage === 0) {
      stage = 1;
      rl.setPrompt(`Please enter your password:\n`);
    }
    else if (identity[0] === doctorKai.username && answer === doctorKai.password && stage === 1) {
      stage = 2;
      console.log('===================================================');
      console.log(`Welcome, ${doctorKai.name}. Your access level is: ${doctorKai.position}`);
      console.log('===================================================');
      console.log('What would you like to do?');
      console.log('\nOptions:\n');
      console.log('[1] list patients');
    ...
    else if (identity[0] === adminKai.username && answer === adminKai.password && stage === 1) {
      stage = 2;
      console.log('===================================================');
      console.log(`Welcome, ${adminKai.name}. Your access level is: ${adminKai.position}`);
      console.log('===================================================');
      console.log('What would you like to do?');
      console.log('\nOptions:\n');
      console.log('[1] list employees');
    ...
    else if (identity[0] === doctorKai.username) {
      if (stage === 2) {
        switch (answer) {
          case '1':
    ...
    else if (identity[0] === adminKai.username) {
      if (stage === 2) {
        switch (answer) {
          case '1':
